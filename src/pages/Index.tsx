        ...
        <div className="page-container">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Select Your Tool</h3>
              <p className="text-muted-foreground">Choose between Quiz Generator or Topic Explainer based on your learning needs</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Customize Your Request</h3>
              <p className="text-muted-foreground">Specify the subject, education level, and other preferences</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Get AI-Generated Content</h3>
              <p className="text-muted-foreground">Receive personalized quizzes or explanations tailored to your specifications</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <span className="ml-2 text-lg font-bold">QuizGenius</span>
            </div>
